            ...
            <div>
              ...
              <div className="flex space-x-4">
                <a 
                  ...
                  className="bg-neutral-100 text-neutral-700 hover:bg-blue-100 hover:text-blue-700 transition-colors p-3 rounded-full"
                  aria-label="Facebook"
                >
                  <Facebook size={20} />
                </a>
                ...
                <a 
                  ...
                  target="_blank" 
                  rel="noopener noreferrer" 
                  className="bg-neutral-100 text-neutral-700 hover:bg-blue-100 hover:text-blue-600 transition-colors p-3 rounded-full"
                  aria-label="Twitter"
                >
                  <Twitter size={20} />
                </a>
