          ...
          <div>
            ...
            <form className="space-y-2">
              <input
                ...
                className="w-full px-3 py-2 rounded bg-primary-800 text-white placeholder-primary-300 text-sm border border-primary-700 focus:outline-none focus:ring-1 focus:ring-primary-400"
                required
              />
              <button
                type="submit"
